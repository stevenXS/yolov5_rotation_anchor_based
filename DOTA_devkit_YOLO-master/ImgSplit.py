...
class splitbase():
    def __init__(self,
        ...
        """
        :param basepath: 源数据集路劲：../images/..., ../labelTxt/...
        :param outpath: 裁剪后的输出路劲， eg: the basepath and outputpath have the similar subdirectory, 'images' and 'labelTxt'
        :param code: encodeing format of txt file
        :param gap: 两个patch之间的重叠度，重叠度越大，裁剪的图片数量越多
...
if __name__ == '__main__':
    ...
    split = splitbase(r'/home/fofo/A/xsq/datasets/dota-v15/src_img/val_dota_1.5',
                       r'/home/fofo/A/xsq/datasets/dota-v15/non-normal-dota/val_dota')
    split.splitdata(1)