    ...
    for fullname in filelist:  # 'example_split/../P0001.txt'
        ...
        with open(fullname, 'r') as f_in:
            ...
            for splitline in splitlines:  # splitline:每行中的m个元素
                ...
                poly = list(map(float, splitline[2:10]))  # 每个元素映射为浮点数 再放入列表中,TODO:第10行是类别名，所以不能转化为float，2021年11月23日2
...
if __name__ == '__main__':
    ...
    mergebypoly(r'/home/fofo/A/xsq/yolov5_rotation_anchore_free_decoupled_centernet/runs/detect/exp6/labels', r'/home/fofo/A/xsq/yolov5_rotation_anchore_free_decoupled_centernet/runs/detect/exp6/labels/result')
    # mergebyrec()