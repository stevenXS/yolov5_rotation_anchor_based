...
def NEW_DOTA2COCO(srcpath, destfile):
    imageparent = os.path.join(srcpath, 'images')
    labelparent = os.path.join(srcpath, 'labelTxt')
...
if __name__ == '__main__':
    # DOTA2COCO(r'/home/fofo/A/xsq/datasets/dota-v15/rotate_val', r'/home/fofo/A/xsq/datasets/dota-v15/rotate_val/annotation/rotate_val.json')

    # TODO:2021年11月23日21:40:24，add
    NEW_DOTA2COCO(r'/home/fofo/A/xsq/datasets/dota-v15/non-normal-dota/val_dota',
                  r'/home/fofo/A/xsq/datasets/dota-v15/non-normal-dota/val_dota/annotation/rotate_val.json')
